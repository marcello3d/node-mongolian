 ...
 */  
MongolianDB.prototype.authenticate = function(username, password, callback) {
    var self = this
    ...
    self.queryCommand({ getnonce:1 }, safetyNet(callback, function(nonce) {
        ...
        self.queryCommand({
            ...
            nonce:nonce, 
            key:key
        }, function(){ this_auth_complete = true; this._auth_in_progress = false; callback();    })
    }))
}
